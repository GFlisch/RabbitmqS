...
cd /home/client
openssl pkcs12 -export -out key-store.p12 -in cert.pem -inkey key.pem -passout pass:P@ssw0rd

# Create a trust store that will contain the certificate of our CA.
openssl pkcs12 -export -out trust-store.p12 -in /home/testca/cacert.pem -inkey /home/testca/private/cakey.pem -passout pass:P@ssw0rd
